...
-- =====================================================
-- Retire EXECUTE global et limite aux rôles utiles.
-- Fonctions internes (triggers) : service_role uniquement.
-- Fonctions helpers (auth_is_*) : authenticated + service_role.
