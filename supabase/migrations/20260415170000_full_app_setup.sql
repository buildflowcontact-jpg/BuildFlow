...
GRANT EXECUTE ON FUNCTION auth_is_project_member(UUID) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION auth_is_project_owner(UUID) TO anon, authenticated, service_role;
